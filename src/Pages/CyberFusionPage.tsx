...
export default function CyberFusionPage() {
    return (
        <>
            <SubpageHader />
            <PageTitle title="Cyber Fusion" subtitle="Pixel Storm Game Studio" icon={icon} banner={defendTheCity} />
            ...
            <Section name="Android">
                <Social className="highlighted" href="https://play.google.com/store/apps/details?id=com.PixelStorm.CyberPolice2" icon={<GooglePlayIcon />}>
                    Install now!
                </Social>
            </Section>
            ...
            <Section name="Core team">
                <TeamList>
                    <Member name="Michał Kaleta" href="https://github.com/Majkel1999">Our all-embracing team leader and powerful developer. 💪</Member>
                    ...
                    <Member name="Jakub Michalski" href="https://github.com/BiggerPanda">The UI/UX 💬 specialist who fights for the players experience from the very beginning!</Member>
